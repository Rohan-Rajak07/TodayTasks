...
const Card = ({title ,description ,onDelete ,refrence}) => {
  ...
  return (
    <motion.div drag dragConstraints={refrence} whileDrag={{scale:1.01}} className= {
      ...
      "relative sm:h-[40%] h-[32%] w-[200px] bg-zinc-900/50 rounded-3xl  text-white overflow-hidden shrink-0 relative z-0"}>
      ...
      <p className={ShowNote?"text-base m-5 leading-tight text-gray-300":"m-5 leading-tight text-sm "}>{description}</p>
